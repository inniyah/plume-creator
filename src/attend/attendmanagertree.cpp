#include "attendmanagertree.h"

AttendManagerTree::AttendManagerTree(QWidget *parent) :
    QTreeView(parent)
{
...
void AttendManagerTree::postConstructor()
{
...
void AttendManagerTree::itemCollapsedSlot(QModelIndex index)
{
...
void AttendManagerTree::itemExpandedSlot(QModelIndex index)
{
...
QList<QModelIndex> AttendManagerTree::allIndexesFromModel(QAbstractItemModel *model, const QModelIndex &parent)
{
...
//-----------------------------------------------------------------------------------------
void AttendManagerTree::selectionChanged(const QItemSelection &selected, const QItemSelection &deselected)
{
...
//-----------------------------------------------------------------------------------------
void AttendManagerTree::dragEnterEvent( QDragEnterEvent *event )
{


    const QMimeData *data = event->mimeData();

    if (data->hasFormat("application/x-plumecreator-attendmanagerdata")){
...
//-----------------------------------------------------------------------------------------
void AttendManagerTree::dragLeaveEvent( QDragLeaveEvent *event )
{
...
void AttendManagerTree::dropEvent(QDropEvent* event)
{
//    qDebug() << "drop event";
...
void AttendManagerTree::itemClicked(QModelIndex index)
{
...
//----------------------------------------------------------------------------------
void AttendManagerTree::contextMenuEvent(QContextMenuEvent *event)
{
